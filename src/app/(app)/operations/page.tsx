...
export default async function OperationsPage() {
  ...
  return (
    <div className="space-y-6">
      <SectionTitle
        description={`Steel Potatoes LLC · ${formatNumber(membership.lives)} covered lives. Activity through the selected date.`}
      >
        Live operations
      </SectionTitle>
