...
export default function WelcomePage() {
  return <main className={styles.page}>
    <header className={styles.header}><Link href="/" className={styles.brand}>glass</Link><span className={styles.demo}>Product concept · Demo data</span></header>
    ...
    <footer className={styles.footer}>Transparent pharmacy benefits for small employers. This demo uses historical Wisconsin ETF / Navitus terms and simulated members.<Link href="/methodology">Sources & assumptions <ArrowUpRight size={12}/></Link></footer>
  </main>;
}
