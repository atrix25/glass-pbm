 ...
 * — the book was priced before reversals were written. Live member surfaces
 * (detail gauges, agent accumulators) and point-of-sale quotes do not: they
 * answer "what is true now," so a fill whose reversal has already posted must
 * drop out.
 */
